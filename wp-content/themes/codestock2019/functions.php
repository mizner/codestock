...
/**
 * @package CodeStock
 * @author  CodeStock Inc. <development@pyxl.com>
 * @license GPLv3+
 * @version 3.0.0
...
add_action('admin_notices', function () {
    if (!class_exists(Timber::class)) {
        echo '<div class="error"><p>' . __('<strong>Warning:</strong> The theme needs plugin <a href=" ' . get_admin_url() . '/plugin-install.php?s=timber&tab=search&type=term" target="_blank"><strong>Timber</strong></a> to function',
                'my-theme') . '</p></div>';
    }
});
