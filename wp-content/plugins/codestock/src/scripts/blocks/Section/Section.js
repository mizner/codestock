// https://github.com/WordPress/gutenberg/issues/4900
// https://github.com/WordPress/gutenberg/issues/11523#issuecomment-437851918
// https://github.com/Impuls-Werbeagentur/impuls-section-block/blob/master/blocks/src/section-block/block.js

const { domReady, blocks, hooks } = wp;
const { getBlockTypes, unregisterBlockType, registerBlockType, createBlock } = wp.blocks;
const { __ } = wp.i18n;
...
domReady(()=> console.log(getBlockTypes()))

function Section () {
  console.log('register section block');
